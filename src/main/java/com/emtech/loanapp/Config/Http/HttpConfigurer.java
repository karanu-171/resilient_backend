...
//        configuration.setAllowedHeaders(Arrays.asList("Access-Control-Allow-Origin: *","Access-Control-Allow-Credentials:  Origin, Content-Type, X-Auth-Token, Authorization, Accept")); // developing
    ...
    CorsWebFilter corsWebFilter() {
        ...
        corsConfig.setAllowedOrigins(Arrays.asList("http://localhost", "http://localhost:80","http://172.16.1.10:4012", "https://resilient-frontend-green.vercel.app/"));

        corsConfig.setAllowedOrigins(Arrays.asList("http://localhost:4012", "http://172.16.1.10:4012", "https://resilient-frontend-green.vercel.app/"));
